...
void main() {
  group('parts', () {
    ...
    test('Test 79', () {
      ...
      expect(
          game.currentTurn
              .processAction(ConstructAction(player, _getPart(48)!, [ResourceType.heart], null, null))
              .item1,
          ValidateResponseCode.ok);
      expect(game.currentTurn.turnState.value, TurnState.selectedActionCompleted);
    });
    ...
    test('Test 87', () {
      ...
      expect(
          game.currentTurn
              .processAction(ConstructAction(player, _getPart(10)!, [ResourceType.heart], null, null))
              .item1,
          ValidateResponseCode.ok);
      expect(game.currentTurn.turnState.value, TurnState.selectedActionCompleted);
