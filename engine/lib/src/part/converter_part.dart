...
class MultipleConverterPart extends Part {
  ...
  MultipleConverterPart(Game game, String id, int level, int cost, ConverterPart converter1, ConverterPart converter2,
      ResourceType resourceType, int vp)
      : converters = <ConverterPart>[converter1, converter2],
        _vp = vp,
        super(game, id, level, PartType.converter, cost, <Trigger>[converter1.triggers[0], converter2.triggers[0]],
